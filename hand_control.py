...
@nrp.MapRobotPublisher("topic_Index_Proximal", Topic('/robot/hollie_013_indexfing_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_Index_Medial", Topic('/robot/hollie_014_indexfing_midsegment_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_index_distal", Topic('/robot/hollie_015_indexfing_topsegment_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_Middle_Proximal", Topic('/robot/hollie_017_midfing_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_Middle_Medial", Topic('/robot/hollie_018_midfing_midsegment_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_middle_distal", Topic('/robot/hollie_019_midfing_topsegment_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_Ring_Proximal", Topic('/robot/hollie_026_ringfinger_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_ring_medial", Topic('/robot/hollie_027_ringfinger_midsegment_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_ring_distal", Topic('/robot/hollie_028_ringfinger_topsegment_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_Pinky_Proximal", Topic('/robot/hollie_022_littlefinger_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_pinky_medial", Topic('/robot/hollie_023_littlefinger_midsegment_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_pinky_distal", Topic('/robot/hollie_024_littlefinger_topsegment_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_Thumb_Opposition", Topic('/robot/hollie_008_thumb_lat_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_Thumb_Flexion", Topic('/robot/hollie_009_thumb_base_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_thumb_medial", Topic('/robot/hollie_010_thumb_tip_rot_joint/cmd_pos', std_msgs.msg.Float64))
@nrp.MapRobotPublisher("topic_thumb_distal", Topic('/robot/hollie_011_thumb_topsegment_bf_rot_joint/cmd_pos', std_msgs.msg.Float64))
