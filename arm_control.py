...
# APPROACH
approach_tray_conf = np.array([0.0, 0.5, -2.0, 0.0, 0.0, 0.0])

# GRASP
grasp_conf_0 = np.array([0.0, 0.5, -2.0, 0.0, 0.0, 0.0])
grasp_conf_1 = np.array([0.05, 0.5, -2.0, 0.0, 0.0, 0.0])
grasp_conf_2 = np.array([0.05, 0.5, -2.0, 0.0, 0.0, 0.0])
grasp_conf_3 = np.array([0.05, 0.5, -2.0, 0.0, 0.0, 0.0])
grasp_conf_4 = np.array([0.05, 0.5, -2.0, 0.0, 0.0, 0.0])
grasp_conf_5 = np.array([0.05, 0.5, -2.0, 0.0, 0.0, 0.0])
grasp_conf_6 = np.array([0.05, 0.5, -2.0, 0.0, 0.0, 0.0])
grasp_conf_7 = np.array([0.05, 0.5, -2.0, 0.0, 0.0, 0.0])
grasp_conf_8 = np.array([0.05, 0.5, -2.0, 0.0, 0.0, 0.0])
grasp_conf_9 = np.array([0.05, 0.5, -2.0, 0.0, 0.0, 0.0])
...
@nrp.MapVariable("dispose_tray_conf", initial_value=dispose_blue_conf)
@nrp.MapVariable("reset_conf", initial_value=reset_conf)
@nrp.Neuron2Robot()
def arm_control(t, command, last_command_executed, approach_tray_conf,
                grasp_conf_1, grasp_conf_2, dispose_tray_conf, reset_conf,
                topic_arm_1, topic_arm_2, topic_arm_3, topic_arm_4,
    ...
    commands_confs = collections.defaultdict(None, {
            ...
            "GRASP": {"1": grasp_conf_1.value, "2": grasp_conf_2.value},
